        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <Link
                href="https://github.com/arsk2512"
                target="_blank"
              ...
              <Link href="mailto:abdrehmankh2@gmail.com">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 hover:text-white"
              ...
              <GlassmorphicCard>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">Abdul Rehman Khan</div>
                  </div>
                  <div className="space-y-1">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            <ProjectCard
              ...
              description="Featuring a complete shopping experience from product discovery to order management."
              tags={["Next.js", "TypeScript", "Redux Toolkit", "Shadcn"]}
              image="/zen-ecommerce.png?height=400&width=600"
              demoUrl="https://zenshop-ecommerce.vercel.app/"
              repoUrl="https://github.com/arsk2512/zenshop-ecommerce"
            />
            <ProjectCard
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">github.com/arsk2512</div>
                  </div>
                </div>
              </div>
        ...
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-2">
              © {new Date().getFullYear()} Abdul Rehman Khan. All rights
              reserved.
            </p>
          </div>
